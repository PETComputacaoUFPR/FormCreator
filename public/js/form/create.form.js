...
$(document).ready(function() {
	...
	$('#single_line_text').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('input', { name: "Edit Input Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_date').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('date', { name: "Edit Date Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_number').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('number', { name: "Edit Number Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_phone').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('phone', { name: "Edit Phone Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_password').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('password', { name: "Edit Password Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_password_verify').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('passwordverify', { name: "Edit Password Verify Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_email').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('email', { name: "Edit Email Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_paragraph').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			secondTab.tab('show');
			$.get('paragraph', { name: "Edit Textarea Field", id: liId}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_checkbox').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('checkbox', { name: "Edit Checkbox Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_radio').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('radio', { name: "Edit Radio Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
	...
	$('#line_dropdown').click(function () {
		...
		$('#'+ liId +' .edit_li').click(function () {
			...
			secondTab.tab('show');
			$.get('dropdown', { name: "Edit Drop Down Field", id: liId, 'length': lengthNr}).done(function(data) {
				fieldProp.html(data);
    ...
    $('#line_upload').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('upload', { name: "Edit Input Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_credit_card').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('creditcard', { name: "Edit Credit Card Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_url').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('url', { name: "Edit Web Site / Url Field", id: liId}).done(function(data) {
                fieldProp.html(data);
    ...
    $('#line_hidden').click(function () {
        ...
        $('#'+ liId +' .edit_li').click(function () {
            secondTab.tab('show');
            $.get('hidden', { name: "Edit Hidden Field", id: liId}).done(function(data) {
                fieldProp.html(data);
